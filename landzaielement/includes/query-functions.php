...
function magnews_orderby_post(){
    return array(
        'none' => __('No order', 'landzaielement'),
        'ID' => __('Post ID', 'landzaielement'),
        'author' => __('Author', 'landzaielement'),
        'title' => __('Title', 'landzaielement'),
        'date' => __('Published date', 'landzaielement'),
        'modified' => __('Modified date', 'landzaielement'),
        'parent' => __('By parent', 'landzaielement'),
        'rand' => __('Random order', 'landzaielement'),
        'comment_count' => __('Comment count', 'landzaielement'),
        'menu_order' => __('Menu order', 'landzaielement'),
        'post__in' => __('By include order', 'landzaielement'),
    );  
}
...
function madmag_ft_images($thumbnail){
    ...
    $placeholder =  Landzai_PLUGIN_URL . 'assets/lazyload.svg';
...
function landzai_get_category_link($taxonomy){
...
function misha_loadmore_ajax_handler(){
    ...
    require Landzai_PLUGIN_DIR.'includes/loops/'. $template .'.php';
    die(); 
}
...
function misha_tabcat_ajax_handler(){
    ...
    //require(Landzai_PLUGIN_DIR.'includes/loops/tabcat.php');
    require Landzai_PLUGIN_DIR.'includes/loops/'. $template .'.php';
    die(); 
}
