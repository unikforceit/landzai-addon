...
function get_builder_image($url='',$class=''){
    ...
    function landzai_service_meta($opt)
    {
    ...
    if ( 'section' === $element->get_name() && 'section_custom_css_pro' === $section_id ) {
        ...
        $element->start_controls_section(
            ...
            [
                ...
                'label' => __( 'Landzai Settings', 'landzai' ),
            ]
        );
        ...
        $element->add_control(
            'header_sticky',
            [
                'label'        =>   __( 'Sticky Section', 'landzai' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     =>   __( 'Yes', 'landzai' ),
                'label_off'    =>   __( 'No', 'landzai' ),
                'return_value' => 'landzai-sticky-header',
                'default'      => '',
                'prefix_class' => '',
            ]
        );
        $element->add_group_control(
            ...
            [
                ...
                'show_label' => true,
                'condition' => [
                    'header_sticky' => 'landzai-sticky-header'
                ],
                'selector' => '{{WRAPPER}}.landzai-sticky-header.sticky-on',
            ]
        );
        ...
        $element->add_responsive_control(
            '_element_width',
            [
                'label' => __( 'Width', 'landzai' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                    '' => __( 'Default', 'landzai' ),
                    'inherit' => __( 'Full Width', 'landzai' ) . ' (100%)',
                    'auto' => __( 'Inline', 'landzai' ) . ' (auto)',
                    'initial' => __( 'Custom', 'landzai' ),
                ],
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => __( 'Vertical Align', 'landzai' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'options' => [
                    'flex-start' => [
                        'title' => __( 'Start', 'landzai' ),
        ...
        $element->add_control(
            ...
            [
                'raw' => '<strong>' . __( 'Please note!', 'landzai' ) . '</strong> ' . __( 'Custom positioning is not considered best practice for responsive web design and should not be used too frequently.', 'landzai' ),
        ...
        $element->add_control(
            '_position',
            [
                'label' => __( 'Position', 'landzai' ),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => '',
                'options' => [
                    '' => __( 'Default', 'landzai' ),
                    'absolute' => __( 'Absolute', 'landzai' ),
                    'fixed' => __( 'Fixed', 'landzai' ),
                ],
        ...
        $start = is_rtl() ? __( 'Right', 'landzai' ) : __( 'Left', 'landzai' );
        $end = ! is_rtl() ? __( 'Right', 'landzai' ) : __( 'Left', 'landzai' );

        $element->add_control(
            '_offset_orientation_h',
            [
                'label' => __( 'Horizontal Orientation', 'landzai' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'toggle' => false,
                'default' => 'start',
                'options' => [
        ...
        $element->add_control(
            ...
            [
                'label' => __( 'Vertical Orientation', 'landzai' ),
                'type' => \Elementor\Controls_Manager::CHOOSE,
                'toggle' => false,
                'default' => 'start',
                'options' => [
                    'start' => [
                        'title' => __( 'Top', 'landzai' ),
                        'icon' => 'eicon-v-align-top',
                    ],
                    'end' => [
                        'title' => __( 'Bottom', 'landzai' ),
                        'icon' => 'eicon-v-align-bottom',
                    ],
                ],
                'render_type' => 'ui',
...
add_action( 'elementor/element/heading/section_title_style/before_section_start', function( $element, $args ) {
    ...
    $element->add_control(
        'text_gra',
        [
            'label' => __( 'Text Gradient', 'landzai' ),
    ...
    $element->add_control(
        'text_transparent',
        [
            'label'        =>   __( 'Transparent', 'landzai' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'landzai' ),
            'label_off'    =>   __( 'No', 'landzai' ),
            'return_value' => 'landzai-text-gradient',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    $element->add_group_control(
        ...
        [
            ...
            'separator' => 'after',
            'condition' => [
                'text_transparent' => 'landzai-text-gradient'
            ],
            'selector' => '{{WRAPPER}}.landzai-text-gradient .elementor-heading-title',
        ]
    );
    $element->add_control(
        'text_sr',
        [
            'label' => __( 'Text Stroke', 'landzai' ),
            'type' => \Elementor\Controls_Manager::HEADING,
        ]
    );
    $element->add_control(
        'text_str',
        [
            'label'        =>   __( 'Turn On Stroke', 'landzai' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'landzai' ),
            'label_off'    =>   __( 'No', 'landzai' ),
            'return_value' => 'landzai-text-stroke',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    $element->add_control(
        's_fill_color',
        [
            'label' => __( 'Fill Color', 'landzai' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'condition' => [
                'text_str' => 'landzai-text-stroke'
            ],
            'selectors' => [
                '{{WRAPPER}}.landzai-text-stroke .elementor-heading-title' => '-webkit-text-fill-color: {{VALUE}}',
            ],
        ]
    );
    $element->add_responsive_control(
        ...
        [
            ...
            'selectors' => [
                '{{WRAPPER}}.landzai-text-stroke .elementor-heading-title' => '-webkit-text-stroke-width: {{SIZE}}{{UNIT}};',
            ],
            'condition' => [
                'text_str' => 'landzai-text-stroke'
            ],
    ...
    $element->add_control(
        's_text_color',
        [
            'label' => __( 'Stroke Color', 'landzai' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'condition' => [
                'text_str' => 'landzai-text-stroke'
            ],
            'selectors' => [
                '{{WRAPPER}}.landzai-text-stroke .elementor-heading-title' => '-webkit-text-stroke-color: {{VALUE}}',
            ],
        ]
    );
    $element->end_controls_section();
...
add_action( 'elementor/element/icon/section_style_icon/before_section_start', function( $element, $args ) {
    ...
    $element->add_control(
        'icon_light_box',
        [
            'label'        =>   __( 'Turn On LightBox', 'landzai' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'landzai' ),
            'label_off'    =>   __( 'No', 'landzai' ),
            'return_value' => 'landzai-icon-lightbox',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    $element->add_control(
        'icon_gradient',
        [
            'label'        =>   __( 'Turn On Gradient', 'landzai' ),
            'type'         => \Elementor\Controls_Manager::SWITCHER,
            'label_on'     =>   __( 'Yes', 'landzai' ),
            'label_off'    =>   __( 'No', 'landzai' ),
            'return_value' => 'landzai-icon-gradient',
            'default'      => 'false',
            'prefix_class' => '',
        ]
    );
    ...
    $element->start_controls_tab(
        ...
        [
            'label' => __( 'Normal', 'appilo' ),
            'condition' => [
                'icon_gradient' => 'landzai-icon-gradient'
            ],
        ]
    );
    $element->add_control(
    ...
    $element->add_group_control(
        ...
        [
            ...
            'show_label' => true,
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.landzai-icon-gradient .elementor-icon i',
        ]
    );
    $element->add_control(
        'atext_gra',
    ...
    $element->add_group_control(
        ...
        [
            ...
            'show_label' => true,
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.landzai-icon-gradient .elementor-icon',
        ]
    );
    $element->end_controls_tab();
    ...
    $element->add_group_control(
        ...
        [
            ...
            'show_label' => true,
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.landzai-icon-gradient .elementor-icon:hover i',
        ]
    );
    $element->add_control(
        'afatext_gra',
    ...
    $element->add_group_control(
        ...
        [
            ...
            'separator' => 'after',
            'selector' => '{{WRAPPER}}.landzai-icon-gradient .elementor-icon:hover',
        ]
    );
    $element->end_controls_tab();
...
function landzaielement_template_select() {
...
/*Meta Fields*/
function landzaielement_animations(){
    return array(
        '' => esc_html__('No animation', 'landzaielement') ,
        'reveal-top' => esc_html__('Animate from top', 'landzaielement') ,
        'reveal-bottom' => esc_html__('Animate from bottom', 'landzaielement') ,
        'reveal-left' => esc_html__('Animate from left', 'landzaielement') ,
        'reveal-right' => esc_html__('Animate from right', 'landzaielement') ,
    );  
}
...
function landzaielement_gird_column($column_size = '3') {
...
function landzaielement_gallery_column($column_size = 3) {
...
function landzai_page_title($arg){
        ...
        if ( is_category() ) {
          ...
          $title = esc_html__( 'Frontpage', 'landzai' );
        } elseif( is_singular() ){
          $title = get_the_title();
        }else {
            $title = esc_html__( 'Archives','landzai' );
        }
