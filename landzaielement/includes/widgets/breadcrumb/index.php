...
class Widget_Landzai_breadcrumb extends Widget_Base {
	...
	============================================= -->
        <section class="medi-inner-page-banner" data-background="<?php echo esc_url($url); ?>">
            <div class="container">
                <h1 class="medi-page-title"><?php echo esc_html($title); ?></h1>
                <div class="medi-pagination ul-li">
