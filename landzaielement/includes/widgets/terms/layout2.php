                    ...
                    if ($settings['faq_list2']) {
                        ...
                        foreach ($settings['faq_list2'] as $faq2) {
                            ...
                            <div class="card-header" id="heading'.$faq2['_id'].'">
                                <button type="button" class="btn btn-link '.$collapsed2.'" data-toggle="collapse" data-target="#collapse'.$faq2['_id'].'"> '.$faq2['f_title2'].'</button>
                            </div>
                            <div id="collapse'.$faq2['_id'].'" class="collapse '.$show2.'" aria-labelledby="heading'.$faq2['_id'].'" data-parent="#accordion-faq-two">
                                <div class="card-body">
                                    <p>'.$faq2['f_info2'].'</p>
                                </div>
                            </div>
