            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-7">
                    <div class="fantastic-info">
                        <div class="section-title-two mb-0">
                            ...
                            <div class="vedio-btn">
                                <a  '.get_that_link($settings['link']).' class="primary-btn-two popup-video" >'.$settings['button'].'</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-5">
                    ...
                    '.get_that_image($settings['image']).'
                        <a  '.get_that_link($settings['link']).' class="play-btn popup-video"><i class="fas fa-play"></i></a>
                    </div>
                </div>
            </div>
        </div>
