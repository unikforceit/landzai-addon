...
function ae_import_files() {
    return array(
        array(
            'import_file_name'           => 'Landzai Home 1',
            ...
            'import_preview_image_url'   => trailingslashit( LANDZAI_DEMO_FILES ).   'home-1/screenshot.jpg',
            'import_notice'              => __( 'All are set with one click demo import', 'landzai' ),
            'preview_url'                => 'http://wp.themexriver.com/landzai',
        ),
    );
}
...
function ae_after_import_setup($selected_import) {
    ...
    if ( class_exists( 'RevSlider' )) {
            ...
            $slider_array = array(
                LANDZAI_DEMO_SLIDER . 'home-1/slider-8.zip',
            );
