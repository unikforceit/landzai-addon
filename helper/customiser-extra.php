...
class landzai_plugins_hooks {
    ...
    function landzai_render_footer(){
        ...
        $meta_switch = landzai_meta('footer_switch');
        $meta_footer = landzai_meta('meta_footer');
    ...
    function landzai_render_header(){
        $meta_switch = landzai_meta('header_switch');
        $meta_header = landzai_meta('meta_header');
    ...
    function landzai_share_tag(){
        ...
        $tagtitle = landzai_options('tag_title');
        $sharetitle = landzai_options('share_title');
    ...
    function landzai_authorbox(){
        ...
        $title = landzai_options('auth_title');
    ...
    function landzai_related_post(){
        $title = landzai_options('related_title');
        $id = $GLOBALS['post']->ID;
    ...
    function landzai_bar_plugin_scripts() {
        ...
        function dynamic_css() {
            ob_start();
            include LANDZAI_PLUG_DIR . '/vendor/frontend/css.php';
    ...
    function landzai_mime_type($mimes) {
